# Generated by Powerlevel10k configuration wizard on 2025-06-23 at 19:45 EEST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 32 )) && branch[18,-14]="…"  # <-- this line
  ...
  # if not running from a docker container then keep the line and hide the context
  if [ ! -f "/.dockerenv" ]; then
