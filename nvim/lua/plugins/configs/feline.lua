...
table.insert(components.active[2], {
	provider = function()
		return (
				require("feline.providers.file").file_format()
				.. " "
				.. require("feline.providers.file").file_encoding()
				):lower()
	end,
	hl = { fg = colors.subtext0, bg = colors.surface0 },
	right_sep = { str = " ", hl = { bg = colors.surface0 } },
...
local function is_disabled(dis)
	...
	if buftype == "nofile" and filetype == "" and bufname == "" then return true end
...
table.insert(components.active[2], {
	...
	hl = { fg = colors.subtext1, bg = colors.base },
